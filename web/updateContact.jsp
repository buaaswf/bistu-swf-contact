<%@ page language="java" import="java.util.*,cn.bistu.entity.*" pageEncoding="utf-8"%>
...
<table align="center" border="1" width="300px">
    ...
    <tr>
    	<th>性别</th>
        <td>
        <input type="radio" name="gender" value="boy"  <c:if test="${contact.gender=='男' }">checked="checked"</c:if> />男
        <input type="radio" name="gender" value= "girl"  <c:if test="${contact.gender=='女' }">checked="checked"</c:if> />女
        </td>
    </tr>
    <tr>
    	<th>年龄</th>
